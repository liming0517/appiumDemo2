 ...
 * 2. Click on Brightness level.
 * 3. Adjust on brightness bar.
 * 4. Hit back key to close brightness bar.
 *
 * Pass Criteria:
 * (1) Brightness bar will pop up when click on Brightness level setting.
 * (2) There is no error found when adjust on brightness bar.
 */
@Controller
@ResponseBody
@RequestMapping("pixel")
public class TestCase1_1_2 {
    ...
    //constructor
    public TestCase1_1_2(AppiumConfig config) {
        this.config = config;
    }
    ...
    public ResponseEntity adjustBrightness() {
        ...
        return ResponseEntity.failed("system error",null);
    }
