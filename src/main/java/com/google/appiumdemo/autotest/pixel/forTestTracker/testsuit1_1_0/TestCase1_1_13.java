...
public class TestCase1_1_13 {
    private static Logger logger = Logger.getLogger(TestCase1_1_13.class);

    @Autowired
    public final AppiumConfig config;

    //constructor
    public TestCase1_1_13(AppiumConfig config) {
        this.config = config;
    }
    ...
    //Todo
    @RequestMapping(value = "testcase1.1.13")
